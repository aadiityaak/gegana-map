...
const props = defineProps<{
    ...
    filters: { type: string | null; province_id: string | null; view?: string };
}>();
...
<template>
    ...
    <div class="p-4 font-mono sm:p-6">
        ...
        <div v-if="activeTab === 'ai'" class="space-y-4">
            <AiPanel module="wan-teror" @analyzed="onAnalyzed" />
            <AiHistoryList ref="historyListRef" module="wan-teror" />
        </div>
