...
const title = computed(() => {
    if (props.mode === 'view') return 'View WAN TEROR';
    return props.mode === 'edit' ? 'Edit WAN TEROR' : 'Tambah WAN TEROR';
});
</script>
    ...
    <div class="p-4 font-mono sm:p-6">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <Button v-if="props.mode === 'view' && props.item" variant="secondary" as-child>
                    <Link :href="`/wan-teror/${props.item.id}/edit`">Edit</Link>
                </Button>
            </div>
        </div>
        ...
        <div v-if="isView" class="space-y-4">
            ...
            <div v-if="isView && props.developments && props.developments.length" class="space-y-2">
                <div class="text-sm tracking-widest text-sky-300">PERKEMBANGAN KASUS</div>
                <div class="space-y-2">
                    <div
                    ...
                    >
                        ...
                        <p v-if="dev.description" class="text-sm leading-relaxed text-sky-300">
                            {{ dev.description }}
                        </p>
                        <a
                            v-if="dev.source_url"
            ...
            <div class="grid gap-2">
                ...
                <div v-if="isView">
                    <div v-if="(form.existing_photos ?? []).length > 0" class="grid gap-2">
                        <div class="text-sm text-sky-300">> foto tersimpan</div>
                    ...
                    <div v-else class="text-sm text-sky-300">> tidak ada foto.</div>
                </div>
                <input
                    ref="photoInputEl"
                    type="file"
                ...
                <button
                    v-if="!isView"
                    type="button"
                    class="w-full rounded-lg border border-dashed border-sky-500/25 bg-black/30 px-3 py-6 text-left text-sm text-sky-200/85"
                ...
                >
                    <div class="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div
                            ...
                            class="rounded border border-sky-500/15 bg-black/20 px-2 py-1 text-[11px] text-sky-200/85"
                        >
                ...
                <div v-if="!isView && newPhotoPreviews.length > 0" class="grid gap-2">
                    <div class="text-sm text-sky-300">> preview foto baru</div>
                    <div class="grid grid-cols-2 gap-2 md:grid-cols-4">
                        <button
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        ...
                        :disabled="isView || !form.province_id || loadingRegencies"
                    >
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        ...
                        :disabled="isView || !form.regency_id || loadingDistricts"
                    >
                        <SelectTrigger class="w-full">
                ...
                <div class="grid gap-2">
                    ...
                    <Select
                        ...
                        :disabled="isView || !form.district_id || loadingVillages"
                    >
                        <SelectTrigger class="w-full">
